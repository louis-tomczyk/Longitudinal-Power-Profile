...
function E = filterenv(E,lam,Hf)
    ...
    freqc   = CONSTANTS.CLIGHT./E.lambda;
    % central frequency [GHz] (corresponding to the zero
    % frequency of the lowpass equivalent signal by convention
    
    freq    = CONSTANTS.CLIGHT./lam;    % [GHz] carrier frequency
    deltafn = freqc - freq;             % [GHz] carrier frequency spacing
    minfreq = GSTATE.FN(2)-GSTATE.FN(1);% [GHz] resolution
